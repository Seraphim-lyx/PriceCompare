...
public class SampleListFragment extends Fragment implements OnItemClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View v =inflater.inflate(R.layout.fragment_samplelist, null);
		this.mView = v;
		return v;
	}
	...
	private void init() {
		// TODO Auto-generated method stub
		mPullRefreshListView = (PullToRefreshListView) mView.findViewById(R.id.fsSamplelist);
		...
		mListView = (ListView) mView.findViewById(R.id.fspush_list);
		mListView.setOnItemClickListener(this);
		group = (RadioGroup) mView.findViewById(R.id.fsgroup);
		kindBtn = (RadioButton) mView.findViewById(R.id.fskind);
		kindBtn.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				getActivity().getSupportFragmentManager().beginTransaction()
				.replace(R.id.fsfragment_container, kindFragment).commit();
		
			}
		});
		sortBtn = (RadioButton) mView.findViewById(R.id.fssort);
		sortBtn.setOnClickListener(new OnClickListener(){
			@Override
			public void onClick(View v) {
				getActivity().getSupportFragmentManager().beginTransaction()
				.replace(R.id.fsfragment_container, sortFragment).commit();

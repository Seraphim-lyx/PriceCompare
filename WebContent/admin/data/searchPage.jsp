...
function addInput(content){
	...
	$("#"+content).append("<label>&nbsp商品类型名称：</label>");
	$("#"+content).append("<input type='text' name='productNames'style='width:200px;'/>");
	$("#"+content).append("</div>");
}
...
<div class="pageContent">
	<div class="tabs">
      ...
      <div class="tabsContent" style="height:190px;">
            ...
            <div>
				<form method="post" action="nameDataSearch?action=nameDataSearch" name="nameForm" onsubmit="return navTabSearch(this)">
				<div style="height:140px;" id="nameFormContent">
					<div class="unit">
						<label>商品类型名称：</label>
						<input type="text" name="productNames" />
					</div>	
				</div>
				<div class="formBar">
					<ul>
            ...
            <div>
				<form method="post" action="typeDataSearch?action=typeDataSearch" name="typeForm" onsubmit="return navTabSearch(this)" > 
			...
			<div>
				<form method="post" action="priceDataSearch?action=priceDataSearch" onsubmit="return validatePrice(this)">
			 ...
			 <div>
				<form method="post" action="mixDataSearch?action=mixDataSearch" name="nameForm" onsubmit="return navTabSearch(this)">

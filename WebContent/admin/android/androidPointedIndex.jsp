...
<div class="panelBar">
	...
	<div class="panelBar">
		<div>
		<form  method="post" action="androidPricePointed?order=0" onsubmit="return navTabSearch(this)">
			<input type="hidden" name="pageNum" value="${requestScope.pageNum}" />
			<input type="hidden" name="numPerPage" value="${requestScope.numPerPage}" />
		...
		<div>
		<form method="post" action="androidPricePointed?order=1" onsubmit="return navTabSearch(this)">
			<input type="hidden" name="pageNum" value="${requestScope.pageNum}" />
			<input type="hidden" name="numPerPage" value="${requestScope.numPerPage}" />

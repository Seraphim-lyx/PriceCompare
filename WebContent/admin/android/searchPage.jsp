...
<div class="pageContent">
	<div class="tabs">
      ...
      <div class="tabsContent" style="height:190px;">
            ...
            <div>
				<form method="post" action="nameAndroidSearch?action=nameAndroidSearch" name="nameForm" onsubmit="return navTabSearch(this)">
            ...
            <div>
				<form method="post" action="typeAndroidSearch?action=typeAndroidSearch" name="typeForm" onsubmit="return navTabSearch(this)" > 
			...
			<div>
				<form method="post" action="priceAndroidSearch?action=priceAndroidSearch" onsubmit="return validatePrice(this)">
			 ...
			 <div>
				<form method="post" action="mixAndroidSearch?action=mixAndroidSearch" name="nameForm" onsubmit="return navTabSearch(this)">
